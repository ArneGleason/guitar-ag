...
- New plugin instances should open as `v0.3.0 / StringVoice EG-083 InputOctave`.
...
- The editor identity line should show the current model label, for example `StringVoice EG-083 InputOctave`.

...
- New plugin instances should open as `v0.2.6 / StringVoice EG-063 FretSlide`.
...
- The editor identity line should show the current model label, for example `StringVoice EG-063 FretSlide`.

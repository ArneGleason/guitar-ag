...
- New plugin instances should open as `v0.3.0 / StringVoice EG-085 SlidePanicReset`.
...
- The editor identity line should show the current model label, for example `StringVoice EG-085 SlidePanicReset`.

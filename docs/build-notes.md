...
- New plugin instances should open as `v0.3.0 / StringVoice EG-086 PanicReset`.
...
- The editor identity line should show the current model label, for example `StringVoice EG-086 PanicReset`.

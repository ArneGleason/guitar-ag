...
public:
    ...
    static constexpr auto strumBalanceParameterId = "strumBalance";
    ...
    static constexpr auto slideSqueakDownParameterId = "slideSqueakDown";
...
private:
    ...
    std::atomic<float>* strumBalanceParameter = nullptr;
